import {
  ...
  Typography, CircularProgress, MenuItem, IconButton
} from "@mui/material";
...
export default function DocumentManagement() {
  ...
  return (
    <Box sx={{ width: "100%", height: "calc(100vh - 100px)", display: "flex", flexDirection: "column", gap: 2, p: 1, boxSizing: "border-box" }}>
        ...
        <Table size="small" stickyHeader sx={{ tableLayout: "fixed", width: "100%" }}>
          <TableHead>
            <TableRow>
              ...
              <TableCell style={{ width: "22%" }}>Doc name</TableCell>
              <TableCell style={{ width: "22%" }}>Category</TableCell>
              <TableCell style={{ width: "80px" }}>Version</TableCell>
              <TableCell style={{ width: "11%" }}>Uploaded by</TableCell>
              <TableCell style={{ width: "11%" }}>Updated by</TableCell>
              <TableCell style={{ width: "100px" }}>Created date</TableCell>
              <TableCell style={{ width: "100px" }}>Updated date</TableCell>
              <TableCell style={{ width: "90px" }} align="center">Action</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {loading ? (
      ...
      {/* Pagination Command Bar Footer */}
      {!loading && total > 0 && (
        <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 1, mt: 0.5 }}>
          <Button size="small" variant="outlined" disabled={page === 1} onClick={() => setPage(p => p - 1)}>Prev</Button>
          <Typography variant="caption" sx={{ mx: 1 }}>Page {page} of {totalPages}</Typography>
