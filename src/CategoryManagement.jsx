    ...
    return (
        <Box sx={{ width: "100%", height: "calc(100vh - 150px)", display: "flex", flexDirection: "column", gap: 2, p: 1, boxSizing: "border-box" }}>
            <Box sx={{ display: "flex", gap: 2, alignItems: "center" }}>
                <TextField
                    label={t("categoryManagement.searchPlaceholder", "Search Main Category, Sub Category or Remarks...")}
                    value={search}
                    size="small"
                    sx={{ flexGrow: 1 }}
                ...
                <Button variant="contained" onClick={() => { setError(""); setAddOpen(true); }} sx={{ minWidth: "160px", height: "40px" }}>
                    {t("categoryManagement.addCategory", "Add Category")}
                </Button>
            </Box>
                ...
                <TableContainer component={Paper} variant="outlined" sx={{ flexGrow: 1, overflowY: "auto" }}>
                    <Table size="small" stickyHeader sx={{ tableLayout: "fixed", width: "100%" }}>
                        <TableHead sx={{ bgcolor: "action.hover" }}>
                            <TableRow>
                                <TableCell style={{ width: "50px", fontWeight: "bold" }}>{t("categoryManagement.colNo", "No.")}</TableCell>
                                <TableCell style={{ width: "250px", fontWeight: "bold" }}>{t("categoryManagement.colCategoryName", "Category Name")}</TableCell>
                                <TableCell style={{ width: "250px", fontWeight: "bold" }}>{t("categoryManagement.colSubCategory", "Sub Category Name")}</TableCell>
                                <TableCell style={{ width: "350px", fontWeight: "bold" }}>{t("categoryManagement.colDescription", "Description")}</TableCell>
                                <TableCell style={{ width: "100px", fontWeight: "bold", textAlign: "center" }}>{t("categoryManagement.colActions", "Actions")}</TableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
                            {categories.length > 0 ? (
